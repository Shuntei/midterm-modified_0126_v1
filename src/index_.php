      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="tables">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="../pages/tables/basic-table.html">點數消耗紀錄</a></li>
              <li class="nav-item"> <a class="nav-link" href="../pages/tables/basic-table.html">貼圖管理</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item">
