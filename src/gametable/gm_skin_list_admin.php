              ...
              <div class="home-tab">
                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom mb-5">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="more-tab" href="gm_user_achieved_list_admin.php" role="tab" aria-selected="overview">Mission</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link border-0 active" id="more-tab" aria-current="page" href="#" role="tab" aria-selected="true">Skin</a>
                    </li>
                  </ul>
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <a href="gm_skin_add.php" class="btn btn-primary text-white me-0"><i class="mdi mdi-plus fw-bold"></i> Add</a>
                    </div>
                  </div>
                </div>
                <!-- change page btn end -->
                          ...
                          <tbody>
                            ...
                            <?php foreach ($rows as $r) : ?>
                                <tr>
                                    ...
                                    <td><?= $r['skin_id'] ?></td>
                                    <td><?= $r['skin_name'] ?></td>
                                    <td><?= $r['skin_model_id'] ?></td>
                                    <td><?= $r['role'] ?></td>
                                    <td><?= $r['file'] ?></td>
                                    <td><?= $r['skin_last_update'] ?></td>
                                    <td>
